...
**[Open the live studio →](https://sudopimp.github.io/HBlobs/)** — one flat blob, full tab. Click to cycle product states.
...
| You | Open |
| --- | --- |
| Anyone | [Live studio](https://sudopimp.github.io/HBlobs/) — flat, live engine |
| Embed | [site/embed.html](https://sudopimp.github.io/HBlobs/site/embed.html) — `state` `follow` `--blob-fill` |
